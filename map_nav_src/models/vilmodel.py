...
class GlocalTextPathNavCMT(BertPreTrainedModel):
    ...
    def forward_text(self, txt_ids, txt_masks, knowledges, knowledges_lens):
        ...
        for layer_module in self.knowledges_text_encoder.x_layers:
            vp_knowledges_embeds = layer_module.forward_lang2visn(
                txt_embeds, extended_txt_masks,
    ...
    def forward_navigation_per_step(
        ...
        vp_img_embeds, vp_pos_fts, vp_masks, vp_nav_masks, vp_obj_masks, vp_cand_vpids,knowledges, knowledges_lens
    ):
    ...
    def forward(self, mode, batch, **kwargs):
        if mode == 'language':
            txt_embeds = self.forward_text(batch['txt_ids'], batch['txt_masks'], batch['knowledges'], batch['knowledges_lens'])
            return txt_embeds
            ...
            return pano_embeds, pano_masks
             ...
             return self.forward_navigation_per_step(
                ...
                batch['vp_nav_masks'], batch['vp_obj_masks'], batch['vp_cand_vpids'],
                 batch['knowledges'], batch['knowledges_lens'],
            )
