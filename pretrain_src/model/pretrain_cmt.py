...
class GlocalTextPathCMTPreTraining(BertPreTrainedModel):
    ...
    def forward(self, batch, task, compute_loss=True):
        ...
        if task.startswith('mlm'):
            return self.forward_mlm(
                ...
                batch['txt_labels'], batch['knowledges'], batch['knowledges_lens'], compute_loss
            )
            ...
            return self.forward_mrc(
                ...
                batch['vp_obj_mrc_masks'], batch['vp_obj_probs'], batch['knowledges'], batch['knowledges_lens'], compute_loss
            )
            ...
            return self.forward_sap(
                ...
                batch['global_act_labels'], batch['local_act_labels'], batch['knowledges'], batch['knowledges_lens'], compute_loss,
            )
            ...
            return self.forward_og(
                ...
                batch['gmap_lens'], batch['gmap_step_ids'], batch['gmap_pos_fts'], 
                batch['gmap_pair_dists'], batch['gmap_vpids'], batch['vp_pos_fts'],
                batch['obj_labels'], batch['knowledges'], batch['knowledges_lens'], compute_loss
            )
    ...
    def forward_mlm(
        ...
        txt_labels, knowledges, knowledges_lens, compute_loss
    ):
        txt_embeds = self.bert.forward_mlm(
            txt_ids, txt_lens, traj_view_img_fts, traj_obj_img_fts, traj_loc_fts, traj_nav_types, 
            traj_step_lens, traj_vp_view_lens, traj_vp_obj_lens, traj_vpids, traj_cand_vpids,
            gmap_lens, gmap_step_ids, gmap_pos_fts, gmap_pair_dists, gmap_vpids, vp_pos_fts, knowledges, knowledges_lens
        )
    ...
    def forward_mrc(
        ...
        traj_step_lens, traj_vp_view_lens, traj_vp_obj_lens, traj_vpids, traj_cand_vpids,
        gmap_lens, gmap_step_ids, gmap_pos_fts, gmap_pair_dists, gmap_vpids, vp_pos_fts,
        vp_view_mrc_masks, vp_view_probs, vp_obj_mrc_masks, vp_obj_probs, knowledges, knowledges_lens, compute_loss=True,
    ):
        _, vp_embeds = self.bert(
            txt_ids, txt_lens, traj_view_img_fts, traj_obj_img_fts, traj_loc_fts, traj_nav_types, 
            traj_step_lens, traj_vp_view_lens, traj_vp_obj_lens, traj_vpids, traj_cand_vpids,
            gmap_lens, gmap_step_ids, gmap_pos_fts, gmap_pair_dists, gmap_vpids, vp_pos_fts, knowledges,
            knowledges_lens, return_gmap_embeds=False
        )
    ...
    def forward_sap(
        ...
        traj_step_lens, traj_vp_view_lens, traj_vp_obj_lens, traj_vpids, traj_cand_vpids,
        gmap_lens, gmap_step_ids, gmap_pos_fts, gmap_pair_dists, gmap_vpids, vp_pos_fts,
        gmap_visited_masks, global_act_labels, local_act_labels, knowledges, knowledges_lens, compute_loss
    ):
    ...
    def forward_og(
        ...
        traj_step_lens, traj_vp_view_lens, traj_vp_obj_lens, traj_vpids, traj_cand_vpids,
        gmap_lens, gmap_step_ids, gmap_pos_fts, gmap_pair_dists, gmap_vpids, vp_pos_fts,
        obj_labels, knowledges, knowledges_lens, compute_loss
    ):
    ...
    def forward_sap_og(
        ...
        traj_step_lens, traj_vp_view_lens, traj_vp_obj_lens, traj_vpids, traj_cand_vpids,
        gmap_lens, gmap_step_ids, gmap_pos_fts, gmap_pair_dists, gmap_vpids, vp_pos_fts,
        gmap_visited_masks, global_act_labels, local_act_labels, obj_labels, knowledges, knowledges_lens
    ):
        batch_size = txt_ids.size(0)
