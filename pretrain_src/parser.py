...
def load_parser():
    ...
    parser.add_argument(
        "--model_config", default='config/r2r_model_config.json', type=str, help="path to model structure config json"
    )
    parser.add_argument(
    ...
    parser.add_argument("--config", default='config/r2r_pretrain.json', help="JSON config files")
