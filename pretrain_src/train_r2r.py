...
def main(opts):
    ...
    if default_gpu:
        opts.model_config = 'config/r2r_model_config.json'
    ...
    tokenizer = AutoTokenizer.from_pretrained(model_config.lang_bert_name, local_files_only=True)
        ...
        if opts.init_pretrained == 'bert':
            ...
            for param_name, param in tmp.items():
                ...
                if 'bert.encoder.layer' in param_name:
                    ...
                    param_name3 = param_name.replace('bert.encoder.x_layers', 'bert.knowledges_text_encoder.encoder.x_layers')
                    param_name4 = param_name.replace('bert.encoder.x_layers', 'bert.knowledges_vp_encoder.encoder.x_layers')
