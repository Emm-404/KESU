...
class MlmDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        output['knowledges'] = inputs['knowledges']
        return output
...
def mlm_collate(inputs):
    ...
    batch['knowledges'] = torch.stack(batch['knowledges'])
    batch['knowledges_lens'] = torch.LongTensor([len(x) for x in batch['knowledges']])
